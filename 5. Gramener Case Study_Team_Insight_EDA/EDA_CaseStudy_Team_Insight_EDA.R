...
dir.create(file.path("C:/Users/gs-1551/Downloads/iiit banglore/EDA CaseStudy", "EdaCaseStudy"), showWarnings = FALSE)

#setting up the work directory
setwd(file.path("C:/Users/gs-1551/Downloads/iiit banglore/EDA CaseStudy", "EdaCaseStudy"))  

# Downloading Uber Request Data
fileUrl <- "https://cdn.upgrad.com/UpGrad/temp/3ba74fb7-bd88-4854-8597-1c225a5aed99/loan.zip"
download.file(fileUrl, destfile = "loan.zip")
zipF<- "C:/Users/gs-1551/Downloads/iiit banglore/EDA CaseStudy/EdaCaseStudy/loan.zip"
outDir<-"C:/Users/gs-1551/Downloads/iiit banglore/EDA CaseStudy/EdaCaseStudy"
...
################# Annual Income
AnnualIncome_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(income_bin)) + 
  geom_bar(fill='red') + ylim(0,6000)+ ggtitle('UA of Annual Income (Loan Paid off)')

AnnualIncome_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(income_bin)) + 
  geom_bar(fill='blue') + ylim(0,6000) + ggtitle('UA of Annual Income (Loan Defaulted)')
grid.arrange(AnnualIncome_ChargeOff, AnnualIncome_PaidOff, ncol = 2)

################# Term
Term_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(term))+ geom_bar(fill='red')+ylim(0,25000)+ggtitle('UA of Term (Loan Paid off)')
Term_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(term))+geom_bar(fill='blue')+ylim(0,25000)+ggtitle('UA of Term (Loan Defaulted)')
grid.arrange(Term_ChargeOff, Term_PaidOff, ncol = 2)

################# Interest Rate
Interest_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(int_rate))+geom_bar(fill='red')+ylim(0,4000)+ggtitle('UA of Interest Rate (Loan Paid off)')
Interest_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(int_rate))+geom_bar(fill='blue')+ylim(0,4000)+ggtitle('UA of Interest Rate (Loan Defaulted)')
grid.arrange(Interest_ChargeOff, Interest_PaidOff, ncol = 2)

################# Loan Amount
LoanAmount_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(loan_amnt_bin))+geom_bar(fill='red')+ylim(0,3000)+ggtitle('UA of Loan Amount (Loan Paid off)')
LoanAmount_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(loan_amnt_bin))+geom_bar(fill='blue')+ylim(0,3000)+ggtitle('UA of Loan Amount (Loan Paid Defaulted)')
grid.arrange(LoanAmount_ChargeOff, LoanAmount_PaidOff, ncol = 2)

################# Grade
Grade_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(grade))+geom_bar(fill='red')+ylim(0,9000)+ggtitle('UA of Grade (Loan Paid off)')
Grade_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(grade))+geom_bar(fill='blue')+ylim(0,9000)+ggtitle('UA of Grade (Loan Defaulted)')
grid.arrange(Grade_ChargeOff, Grade_PaidOff, ncol = 2)

################# Emp_length
EmpLenght_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(emp_length))+geom_bar(fill='red')+ylim(0,5000)+ggtitle('UA of Employee Length (Loan Paid off)')
EmpLength_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(emp_length))+geom_bar(fill='Blue')+ylim(0,5000)+ggtitle('UA of Employee Length (Loan Defaulted)')
grid.arrange(EmpLength_ChargeOff, EmpLenght_PaidOff, ncol = 2)
################# Home Ownership
HomeOwnership_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(home_ownership))+geom_bar(fill='red')+ylim(0,15000)+ggtitle('UA of Home Ownership (Loan Paid off)')
HomeOwnership_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(home_ownership))+geom_bar(fill='blue')+ylim(0,15000)+ggtitle('UA of Home Ownership (Loan Defaulted)')
grid.arrange(HomeOwnership_ChargeOff, HomeOwnership_PaidOff, ncol = 2)
################# purpose
Purpose_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(purpose))+geom_bar(fill='red')+ylim(0,12500)+ggtitle('UA of Purpose (Loan Paid off)')
Purpose_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(purpose))+geom_bar(fill='blue')+ylim(0,12500)+ggtitle('UA of Purpose (Loan Defaulted)')
grid.arrange(Purpose_ChargeOff, Purpose_PaidOff, ncol = 2)
################# Delinq_2yr
Delinq_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(delinq_2yrs))+geom_bar(fill='red')+ylim(0,25000)+ggtitle('UA of Delinq_2yrs (Loan Paid off)')
Delinq_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(delinq_2yrs))+geom_bar(fill='Blue')+ylim(0,25000)+ggtitle('UA of Delinq_2yrs (Loan Defaulted)')
grid.arrange(Delinq_ChargeOff, Delinq_PaidOff, ncol = 2)
################# Public Record
PublicRecord_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(pub_rec))+geom_bar(fill='red')+ylim(0,25000)+ggtitle('UA of Public Record (Loan Paid off)')
PublicRecord_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(pub_rec))+geom_bar(fill='Blue')+ylim(0,25000)+ggtitle('UA of Public Record (Loan Defaulted)')
grid.arrange(PublicRecord_ChargeOff, PublicRecord_PaidOff, ncol = 2)
################# Public Record Bankruptcy
Bankruptcy_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(pub_rec_bankruptcies))+geom_bar(fill='red')+ylim(0,25000)+ggtitle('UA of Public Record (Loan Paid off)')
Bankruptcy_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(pub_rec_bankruptcies))+geom_bar(fill='Blue')+ylim(0,25000)+ggtitle('UA of Public Record (Loan Defaulted)')
grid.arrange(Bankruptcy_ChargeOff, Bankruptcy_PaidOff, ncol = 2)
################# Verification Status
Verification_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(verification_status))+geom_bar(fill='red')+ylim(0,13000)+ggtitle('UA of Verification Status (Loan Paid off)')
Verification_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(verification_status))+geom_bar(fill='Blue')+ylim(0,13000)+ggtitle('UA of Verification Status (Loan Defaulted)')
grid.arrange(Bankruptcy_ChargeOff, Bankruptcy_PaidOff, ncol = 2)
################# DTI
DTI_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(dti_bin))+geom_bar(fill='red')+ylim(0,1500)+ggtitle('UA of DTI (Loan Paid off)')
DTI_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(dti_bin))+geom_bar(fill='blue')+ylim(0,1500)+ggtitle('UA of DTI (Loan Defaulted)')
grid.arrange(DTI_ChargeOff,DTI_PaidOff, ncol = 2)
################# Open_acc
OpenAcc_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(open_acc))+geom_bar(fill='red')+ylim(0,3000)+ggtitle('UA of Open_acc (Loan Paid off)')
OpenAcc_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(open_acc))+geom_bar(fill='blue')+ylim(0,3000)+ggtitle('UA of Open_acc (Loan Defaulted)')
grid.arrange(Bankruptcy_ChargeOff, Bankruptcy_PaidOff, ncol = 2)
################# Total_acc
TotalAcc_PaidOff<-ggplot(subset(loan,loan$loan_status!="Charged Off"),aes(total_acc))+geom_bar(fill='red')+ylim(0,1500)+ggtitle('UA of Total_acc (Loan Paid off)')
TotalAcc_ChargeOff<-ggplot(subset(loan,loan$loan_status=="Charged Off"),aes(total_acc))+geom_bar(fill='blue')+ylim(0,1500)+ggtitle('UA of Total_acc (Loan Defaulted)')
grid.arrange(TotalAcc_ChargeOff, TotalAcc_PaidOff, ncol = 2)
